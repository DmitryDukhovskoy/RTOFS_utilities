"""
  Derive mapping indices gmapi to interpolate ICESat2 data --> mesh025 grid

  ICESat2 ice thickness
  on native grid    
  monthly fields
...
# Get grid data for ICESat2 (EASE grid)
pthfld, flname = mc6util.pathfname_icesnow_mesh025(fyaml, node_nm, 'ICESat2_orig', YR=2021, MM=6)
...
# Global attributes
dset.attrs['title']       = 'Grid mapping between NSIDC Sea Ice Polar Stereographic North EPSG(3411) and MOM6 mesh025 grids'
dset.attrs['institution'] = 'NOAA NWS NCEP MDC'
dset.attrs['source']      = 'get_gmapi_ICESat2_arctic_to_mesh025.py'
dset.attrs['history']     = 'Arctic snow depth, density, sea ice thickness, density from ICESat-2, summer months'
