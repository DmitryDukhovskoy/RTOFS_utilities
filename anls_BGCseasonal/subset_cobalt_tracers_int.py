...
VAROCN = ['nsmp_100', 'nmdp_100', 'nlgp_100', 'nsmz_100', 'nmdz_100', 'nlgz_100']
...
for YR in range(YRS,YRE+1):
  ...
  for MM in MNTHS:
    ...
    for ens in ENSMB:
      ...
      dflin = os.path.join(pthfcst,'ocean_cobalt_tracers_int.nc')
      flout = f'ocean2D_cobalt_tracers_{subdir}.nc'
