...
# snoice - snow-ice formation, cm/day
# dsnow  - snow formation, cm/day
# melts  - top snow melt, cm/day
# snowf  - snowfall rate, cm/day (lwe)
...
match fld_name:
  case 'snoice':
    varnm = 'snoice_d'
    lname = 'snow-ice formation'
  case 'dsnow':
    varnm = 'dsnow_d'
    lname = 'snow formation'
  case 'melts':
    varnm = 'melts_d'
    lname = 'top snow melt'
  case 'snowf':
...
rho_snow = 300.
if fld_name == 'snowf':
  # convert liquid water equival. to cm of snow
...
sttl = f"{lname} cm/day, SFS expt{enmb:02d} ({expt_name}) init {init_date}\n lead time={fday:02d}, {YR}/{MM:02d}/{DD:02d}"
...
btx = 'plot_SFS_snowstate_daily.py'
