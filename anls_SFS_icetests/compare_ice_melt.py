...
parser.add_argument("--fld", help="Plot field", choices=['melts','meltt','meltb'],
...
if fld_name == "meltt":
  strs = f"Ice surf melt ({units}) "
elif fld_name == "meltb":
  strs = f"Basal ice melt ({units}) "
elif fld_name == "melts":
  strs = f"Snow surf melt ({units}) "
