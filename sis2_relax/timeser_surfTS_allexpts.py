...
parser.add_argument("--regn", help="NEPA - Arct.part of NEP only, NEPB - Ber.Sea NEP only,  or ARC - ARC0.08", \
...
for kk in range(nexpts):
  ...
  rlxt = RLXH[kk]
  clr = CLR[kk]
  ln1, = ax1.plot(TMm,fld_mn, '-', linewidth=2, color=clr, label=f'expt {expt_nmb:02d} {rlxt:03d}hrs')
  hndls.append(ln1)
...
if regn == 'NEPA':
  ...
  regn_name = 'ARC0.08 inside rlx zone'
