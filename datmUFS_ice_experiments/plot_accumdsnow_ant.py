"""
  Use from GFSv17 forecasts
  Plot accumulated snow formation over ice cm
  Antarctica Region
...
varnm = 'dsnow_h'  # cm/day, snow formation
TLON = TLAT = LMSK = None
...
rmin = -10.
rmax = 10.
sinfo = 'snow formation (thickness change), cm/day\n'
sinfo = sinfo + pthoutp
...
for hrf in HRFCST:
  ...
  # Need to convert grid cell mean cm/day to ice mean cm/day
...
sttl = f'Cumul. snow form., cm, GFSv17 {expt} init:{init_date}/{init_hr} fcast:{fhrS}-{fhrE} hr'
