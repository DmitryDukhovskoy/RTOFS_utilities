...
input_files = []
pathriv = '/archive/e1n/mom6/NEP/runoff/glofas/nep_10km'
for yr in years:
  dfl = os.path.join(pathriv,f'glofas_v4_hill_dis_runoff_{yr}.nc')
  input_files.append(dfl)

print(f'Reading GLOFASv4 runoff {YR1}-{YR2}')
...
output_dir = '/work/Dmitry.Dukhovskoy/NEP_input/glofas_runoff'
dfriv_out = os.path.join(output_dir, f'GLOFASv4_runoff_NEP_816x342_clim_{YR1}-{YR2}.nc')
