# Plot anomlaies of the ssh fields on orthographic maps
...
metadata = dict(title=f'{expt} dltSSH', artist='Matplotlib',
                comment='created: anim_dltssh.py')
FFwriter = animation.FFMpegWriter(fps=5, metadata=metadata)
flout = f'{expt}_dltSSH_{YR}.mp4'
