...
match gfsv:
  case 16:
    ...
    flgfs = f'gfsv16_hsnow_init{init_date}_days000_016.nc'
    varnm = 'SNOD_surface'  # m
  case 17:
    pthgfs = f'/gpfs/f6/sfs-emc/proj-shared/Dmitry.Dukhovskoy/GFSv17/{init_date}/daily'
    flgfs = f'gfsv17_hsnow_init{init_date}_days000_016.nc'
    varnm = 'hs_h'
...
sttl = f"hsnow GFSv{gfsv} init {init_date}, lead time={fday:02d} days\n {YR}/{MM:02d}/{DD:02d}"

sinfo = 'daily average snow depth on ice from CICE6\n'
sinfo = sinfo + dflice
