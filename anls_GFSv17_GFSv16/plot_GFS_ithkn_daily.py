...
match gfsv:
  case 16:
    ...
    flgfs = f'gfsv16_ithkn_init{init_date}_days000_016.nc'
    varnm = 'ICETK_surface'  # m
  case 17:
    pthgfs = f'/gpfs/f6/sfs-emc/proj-shared/Dmitry.Dukhovskoy/GFSv17/{init_date}/daily'
    flgfs = f'gfsv17_ithkn_init{init_date}_days000_016.nc'
    varnm = 'hi_h'
...
sttl = f"ithkn GFSv{gfsv} init {init_date}, lead time={fday:02d} days\n {YR}/{MM:02d}/{DD:02d}"
