"""
  Plot hsnow instant daily fields from
...
if regn == 'north':
  ...
  raise RuntimeError(f"Uknown regn={regn}")
...
sttl = f"hsnow RTOFS-CICE4 init:{init_date}, lead time={fhr:03d}hrs\n {YR}/{MM:02d}/{DD:02d}"
