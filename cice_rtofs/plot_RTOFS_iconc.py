...
sttl = f"iconc RTOFS-CICE4 init:{init_date}, lead time={fhr:03d}hrs\n {YR}/{MM:02d}/{DD:02d}"
if plt_crct:
  sttl = f"iconc_crct RTOFS-CICE4 init:{init_date}, lead time={fhr:03d}hrs\n {YR}/{MM:02d}/{DD:02d}"
