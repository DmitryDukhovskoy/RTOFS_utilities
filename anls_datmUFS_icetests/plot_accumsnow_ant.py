"""
  ...
  Plot accumulated snowfall on ice 
  Antarctica Region
...
if varnm == 'snow_ai':
  ...
  rmin = 0.
  rmax = 10.
  sinfo = 'cumulative snowfall, cm, grid-cell mean \n'
...
sttl = f'Cumul.snowfall, cm, GFSv17 {expt} init:{init_date}/{init_hr} fcast:{fhrS}-{fhrE} hr'
