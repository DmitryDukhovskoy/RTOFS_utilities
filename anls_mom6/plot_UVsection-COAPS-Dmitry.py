...
with open('paths_expts_macbook.yaml','r') as fid:
  path_dict = yaml.safe_load(fid)

pthoutp = path_dict[nrun]["pthout"]
pthgrid = path_dict[nrun]["pthgrid"]
fgrid   = path_dict[nrun]["fgrid"]
ftopo   = path_dict[nrun]["ftopo"]
...
ffout = os.path.join(pthoutp, floutp)
print('Loading ' + ffout)
