...
if pltfld == 'mean':
  ...
  rmin = 0.
  rmax = 3.
  sinfo = f'Derived from atmos output {varnm} (accumulated surface snow in bucket) (kg/m2) and converted to cm/day\n'
elif pltfld == 'cumul':
  ...
  rmin = 0.
  rmax = 10.
  sinfo = f'Derived from atmos output {varnm} (accumulated surface snow in bucket) (kg/m2) and converted to cm\n'
