...
with xarray.open_dataset(dflice) as dcice:
  ...
  AA = dcice['melts_d'].data.squeeze()    # top snow melt cm/day
...
ax1.set_title(f'UFS expt{enmb:02d} top snow melt cm/day {YR}/{MM:02d}/{DD:02d}')
