"""
  Plot time series of 
  spatially integrated snowfall rate
...
parser.add_argument("--yr", help=f"year of expt, default={YR}", type=int)
parser.add_argument("--ms", help=f"start month of data to plot, default={MM}", type=int)
parser.add_argument("--me", help=f"end month of data to plot, default={MM}", type=int)
parser.add_argument("--ds", help=f"Start: day in the start month to plot, default={DD}", type=int)
parser.add_argument("--de", help=f"End: day in the end month to plot, default={DD}", type=int)
parser.add_argument("--enmb", help="Experiment number = 1, ..., ", type=int, required=True)
...
varnm = 'snow_ai_d'  # cm/day snowfall rate weighted by ice area, grid cell mean
varai = 'aice_d'
varar = 'tarea'      # area of T grid cell, m2
