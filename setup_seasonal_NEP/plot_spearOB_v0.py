"""
  Plot NEP OB from  subset of SPEAR monthly fields
...
mo_plt = 12  # f/cast month to plot
...
for isgm in range(Nsegms):
  ...
  for ie in range(nens):
    ...
    if ie == 0:
      btx0     = btx
      stxt     = f'Monthly SPEAR init: {dstart} {varplt} OB={segm_nm} {dstr}'
    ...
    mutob.plot_Nxsections(F2d, Xsgm, ZM, Hbtm, Xbtm, clrmp, \
